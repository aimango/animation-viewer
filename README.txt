...
How to Run A5:
-done via Eclipse. I did not include the "gen/" folder since they cause trouble with SVN, and are automatically generated by Eclipse when running the project, anyway.
